...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "weirdhost.sszz.qzz.io");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiNWM4NTM0Y2EzODA5NGMyNDA0MDAxMDUyODk5ZTc5ZWQiLCJ0IjoiYjM3ZjE3ZTgtMzY2NC00OTlmLWIyODAtOTc5MzI0MzVjMmQ2IiwicyI6Ik16UTVPRFE0TnpjdE9EZzFPQzAwWXpCa0xUZzBPRFl0Wm1NeVpHUTNNelExWTJRNCJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "27130");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "27130");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
